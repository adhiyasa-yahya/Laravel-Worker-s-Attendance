<?php namespace App\Http\Controllers;
	...
	class AdminEmployesController extends \crocodicstudio\crudbooster\controllers\CBController {

	    public function cbInit() {

			# START CONFIGURATION DO NOT REMOVE THIS LINE
			$this->title_field = "nik";
			$this->limit = "20";
			...
			$this->col[] = ["label"=>"Tlp","name"=>"tlp"];
			# END COLUMNS DO NOT REMOVE THIS LINE

			# START FORM DO NOT REMOVE THIS LINE
			$this->form = [];
			$this->form[] = ['label'=>'Nik','name'=>'nik','type'=>'number','validation'=>'required|integer','width'=>'col-sm-10'];
			$this->form[] = ['label'=>'Name','name'=>'name','type'=>'text','validation'=>'required|string|min:3|max:70','width'=>'col-sm-10','placeholder'=>'You can only enter the letter only'];
			$this->form[] = ['label'=>'Jenis Kelamin','name'=>'jk','type'=>'text','validation'=>'required|min:1','width'=>'col-sm-10'];
			...
			$this->form[] = ['label'=>'Telefon','name'=>'tlp','type'=>'text','validation'=>'required|min:1|max:255','width'=>'col-sm-10'];
